function guardar(){
    ...
    fetch("https://registro-de-us.netlify.app/.netlify/functions/usuarios", requestOptions)
      .then((response) => {
...
function listar(){
    ...
    fetch("https:https://registro-de-us.netlify.app/.netlify/functions/usuarios?iden="+ndoc, requestOptions)
      .then((response) =>
        response.text())
      .then((result) =>
        cargar(result))
